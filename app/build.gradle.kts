...
plugins {
    ...
    id("org.jetbrains.kotlin.plugin.serialization") version libs.versions.kotlin.get() // THE REAL FIX
    id("kotlin-kapt")
...
android {
    namespace = "com.example.vietshare"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.vietshare"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
        ...
        // Make Cloudinary credentials available in BuildConfig
        ...
        // Make SendGrid credentials available in BuildConfig
